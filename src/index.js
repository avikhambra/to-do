...
class TaskList extends React.Component{ 
    ...
    render(){
        ...
        for(let i = 0; i<this.props.tasks.length; i++){
            ...
            if(task.isFinished){
                sapnAction = (
                    <span class="material-icons classHover" onClick={() => this.handleTaskClick(task.desc)}>close</span>
                );
            }else{
                sapnAction = (
                    <span class="material-icons classHover" onClick={() => this.handleTaskClick(task.desc)}>done</span>
                );
            }
